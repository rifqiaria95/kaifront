import { defineComponent, inject, computed, unref, defineAsyncComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, Suspense, nextTick, mergeProps, shallowReactive, ref, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, getCurrentScope, withCtx, useSSRContext } from 'file://C:/laragon/www/kaifront/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/laragon/www/kaifront/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://C:/laragon/www/kaifront/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/laragon/www/kaifront/node_modules/h3/dist/index.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'file://C:/laragon/www/kaifront/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file://C:/laragon/www/kaifront/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/laragon/www/kaifront/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/laragon/www/kaifront/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/laragon/www/kaifront/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/laragon/www/kaifront/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./about-BwfGv13G.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-Blhz-I3V.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-3jCyLJRN.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-DbJ4nCUj.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B_5o51mn.mjs').then((m) => m.default || m)),
  thames: defineAsyncComponent(() => import('./thames-D75R7k04.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DKCogDeb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ASmdpxuV.mjs'));
...
export { _export_sfc as _, __nuxt_component_1$1 as a, __nuxt_component_0 as b, useRouter as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
