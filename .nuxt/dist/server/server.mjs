...
import { createHooks } from "C:/laragon/www/kaifront/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/laragon/www/kaifront/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/laragon/www/kaifront/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu } from "C:/laragon/www/kaifront/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "C:/laragon/www/kaifront/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/laragon/www/kaifront/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-BwfGv13G.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/index-Blhz-I3V.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-3jCyLJRN.js")
  },
  {
    name: "news",
    path: "/news",
    component: () => import("./_nuxt/index-DbJ4nCUj.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-B_5o51mn.js").then((m) => m.default || m)),
  thames: defineAsyncComponent(() => import("./_nuxt/thames-D75R7k04.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DKCogDeb.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-ASmdpxuV.js"));
